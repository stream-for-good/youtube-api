...
class OneVideoLabelOutputDataTransformer extends AbstractController implements ItemDataProviderInterface, RestrictedDataProviderInterface
{
    private $em;
    ...
    private function queryData($id): array
    {
        ...
        $data = $this->repoVideoLabel->find($idVideoLabel);
